...
//      <h2 className={`font-bold text-4xl md:text-8xl w-full text-center mb-6 md:mb-[100px] ${colors.title}`}>
...
<div id="skills" className="pt-2 pb-4 md:py-8">
      {/* TITLE */}
      <h2
        className={`font-bold text-4xl md:text-8xl w-full text-center mb-6 md:mb-[100px] ${colors.title}`}
      >
        Skills
      </h2>
